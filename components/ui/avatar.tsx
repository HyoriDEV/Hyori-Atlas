...
function AvatarFallback({ className, ...props }: AvatarPrimitive.Fallback.Props) {
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "bg-muted text-muted-foreground flex size-full items-center justify-center rounded-full text-sm group-data-[size=2xl]/avatar:text-xl group-data-[size=3xl]/avatar:text-2xl group-data-[size=4xl]/avatar:text-3xl group-data-[size=sm]/avatar:text-xs group-data-[size=xl]/avatar:text-base",
        className
      )}
      {...props}
    />
...
function AvatarGroupCount({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "bg-muted text-muted-foreground ring-background relative flex size-8 shrink-0 items-center justify-center rounded-full text-xs/relaxed ring-2 group-has-data-[size=2xl]/avatar-group:size-16 group-has-data-[size=3xl]/avatar-group:size-20 group-has-data-[size=4xl]/avatar-group:size-24 group-has-data-[size=lg]/avatar-group:size-10 group-has-data-[size=sm]/avatar-group:size-6 group-has-data-[size=xl]/avatar-group:size-12 [&>svg]:size-4 group-has-data-[size=2xl]/avatar-group:[&>svg]:size-8 group-has-data-[size=3xl]/avatar-group:[&>svg]:size-10 group-has-data-[size=4xl]/avatar-group:[&>svg]:size-12 group-has-data-[size=lg]/avatar-group:[&>svg]:size-5 group-has-data-[size=xl]/avatar-group:[&>svg]:size-6",
        className
      )}
      {...props}
    />
