  ...
  function handleConfirmRemove() {
    startTransition(async () => {
      try {
        ...
        toast.error(
          error instanceof Error ? error.message : "Erreur lors du retrait du membre."
        );
      }
    });
  }
    ...
    <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Êtes-vous sûr de vouloir retirer <strong className="text-foreground">{userName}</strong> de l&apos;équipe du staff ?
          </AlertDialogDescription>
        </AlertDialogHeader>

        <div className="bg-destructive/10 text-destructive rounded-md border border-destructive/20 p-3 text-xs">
          L&apos;utilisateur sera rétrogradé au rôle <strong>Joueur</strong> et n&apos;aura plus accès à l&apos;espace staff ni aux outils de modération et de gestion.
        </div>
